...
| NET-016, NET-017, NET-018, NET-055 | network-resource-architecture, placement-architecture, availability-responsibility-architecture, execution-architecture | ADR-0006, ADR-0007, ADR-0015, ADR-0020 | INV-NET-007, INV-NET-008, INV-NET-040, INV-NET-041 | AT-NET-009, AT-NET-010, AT-NET-046, AT-NET-047, FI-NET-007, FI-NET-008, FI-NET-032, FI-NET-033 | Partial (single current Port Binding、generic typed OVN UNBIND、immutable NB/SB/source-OVS retirement evidence、source-quiescence/PortBindingHandoff、exact Port/MAC/IP preservation、Recovery Final Admission/Verification generation fencingを実装。g01→g02 Local LVM/non-empty OVS Port real Recoveryをsame PostgreSQL historyでqualification済み。PCI/SR-IOVとgeneric cleanup authorityは継続) |
