...
| Requirements | Architecture | ADR | Invariants | Tests | 状態 |
|---|---|---|---|---|---|
| NET-001, NET-008, NET-019, NET-020, NET-040, NET-041, NET-042 | network-resource-architecture, architecture, execution-architecture | ADR-0007, ADR-0011, ADR-0020 | INV-NET-006, INV-NET-009, INV-NET-025, INV-NET-026, INV-NET-027 | AT-NET-002, AT-NET-007, AT-NET-011, AT-NET-029, AT-NET-030, AT-NET-031, FI-NET-006, FI-NET-007, FI-NET-021, FI-NET-022, FI-NET-023, XCT-NET-001, XCT-NET-002, XCT-NET-003, XCT-NET-004 | Partial (immutable OVN Port intent、NB/SB/chassis、logical-flow coverage、Chassis/Encap、directed Geneve tunnel evidence authority implemented; production controller runtime、real two-Host Geneve qualification、multi-object Network/Router/DHCP/Security realization pending) |
