...
| CMP-001, CMP-002, CMP-003, CMP-011, CMP-012, CMP-013, CMP-014 | architecture, execution-architecture, placement-architecture, storage-attachment-fencing-architecture, network-resource-architecture | ADR-0002, ADR-0006, ADR-0007, ADR-0019, ADR-0020 | INV-API-001, INV-API-002, INV-API-003, INV-DATA-002, INV-EXEC-006, INV-CMP-001, INV-CMP-002, INV-CMP-003, INV-CMP-004 | AT-CMP-001, AT-CMP-009, AT-CMP-010, AT-CMP-011, AT-CMP-012, AT-API-002 | Partial (Domain/Storage/Image/OVS pre-boot→READY→typed power-on authority implemented; SR-IOV、post-boot dataplane、power execution、delete/public API pending) |
...
| NET-036, NET-037 | network-resource-architecture, agent-protocol, execution-architecture | ADR-0001, ADR-0007, ADR-0020 | INV-NET-021, INV-NET-022, INV-CMP-004 | AT-NET-026, AT-CMP-012 | Partial (OVS pre-boot realization and READY authority implemented; SR-IOV and post-boot dataplane pending) |
