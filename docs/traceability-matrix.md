...
| IAC-020 | infrastructure-lifecycle-iac-architecture, api-principles, terraform-provider-kim | ADR-0029, ADR-0035, ADR-0036, ADR-0037 | INV-API-002, INV-API-003, INV-API-017 | AT-API-002, AT-API-003, AT-IAC-018 | Implemented and qualified for Phase 1, Phase 2 Network/Subnet/unattached Port/backend-neutral Volume, and the bounded Phase 3 logical VM aggregate; maximum create/delete/EVACUATE and logical no-drift pass; multi-Port/multi-Volume Recovery and production mobility remain separate |
