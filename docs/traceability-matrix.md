...
| HGR-004, HGR-005, HGR-021, HGR-026 | host-grouping-architecture, extensibility-architecture, security | ADR-0011, ADR-0014 | INV-HGR-001, INV-HGR-004, INV-HGR-019, INV-HGR-024 | AT-HGR-004, AT-HGR-005, AT-HGR-020, AT-HGR-025, FI-HGR-013, FI-HGR-018, XCT-HGR-001, XCT-HGR-002, XCT-HGR-003, XCT-HGR-004 | Implemented for closed Phase 1 profiles (typed Selector and purpose-limited Ed25519 complete-set External Assertion verification; both require atomic Membership Set materialization with generation/cardinality/hierarchy fencing) |
| HGR-006 | host-grouping-architecture | ADR-0014 | INV-HGR-005, INV-HGR-018 | AT-HGR-019, FI-HGR-003, FI-HGR-012 | Implemented (complete TREE-profile hierarchy generation、immutable level/node/relation evidence、atomic current switch、cycle/level inversion/multi-parent/stale publisher fencing) |
| HGR-008, HGR-009 | host-grouping-architecture, placement-architecture | ADR-0006, ADR-0014 | INV-HGR-006, INV-HGR-007, INV-HGR-018 | AT-HGR-006, AT-HGR-007, AT-HGR-019, FI-HGR-004, FI-HGR-012 | Partial (HostGroup membership/set/cardinality/hierarchy generationとclosed Placement Scope dry/final fencing implemented; weight consumers pending) |
...
| AVR-019 | availability-responsibility-architecture, failure-model, recovery-storm-control-architecture, placement-architecture, storage-resource-architecture | ADR-0006, ADR-0010, ADR-0015, ADR-0017, ADR-0019 | INV-AVR-026, INV-AVR-027, INV-AVR-028, INV-AVR-029 | AT-AVR-021, FI-AVR-015 | Implemented (migration 053: proof current-usability/ABA fencing、typed GLOBAL/PLANNING RecoveryBudgetPolicy exact linkage、immutable destination snapshot、pure Evaluation、explicit Decision+transactional Budget Claim、budget/destination/replay qualification、no Recovery/runtime mutation) |
| AVR-020 | availability-responsibility-architecture, failure-model, recovery-storm-control-architecture, placement-architecture, execution-architecture | ADR-0006, ADR-0007, ADR-0010, ADR-0015, ADR-0017, ADR-0019 | INV-AVR-030, INV-AVR-031, INV-AVR-032, INV-AVR-033 | AT-AVR-022, FI-AVR-016 | Implemented (migration 054: explicit Request/immutable Operation+Plan、start-time safety revalidation、Budget consume+ordinary Final Admission+closed typed preparation dispatch atomicity、UNKNOWN/read-back/dangerous-step gates) |
| AVR-021 | availability-responsibility-architecture, failure-model, recovery-storm-control-architecture, placement-architecture, execution-architecture, storage-attachment-fencing-architecture, network-resource-architecture | ADR-0006, ADR-0007, ADR-0010, ADR-0015, ADR-0017, ADR-0019, ADR-0020 | INV-AVR-034, INV-AVR-035, INV-AVR-036 | AT-AVR-023, FI-AVR-017 | Implemented for closed `RESTART_ON_OTHER_HOST` Local LVM/no-PCI/zero-Port authority. Migration 055-058 and the isolated g01→g02 campaign join actual source/destination observations to one PostgreSQL Failure Epoch→Terminal history. PCI/SR-IOV、non-empty Network、EVACUATE、generic cleanupは継続 |
| AVR-022 | availability-responsibility-architecture, failure-model, storage-attachment-fencing-architecture, execution-architecture | ADR-0007, ADR-0010, ADR-0015, ADR-0019 | INV-AVR-037, INV-AVR-038, INV-AVR-039 | AT-AVR-024, FI-AVR-018 | Implemented (migration 057/058: exact source-root Evaluation/Proof、read-only Lease-bound observation-only `vda` read-back、logical source retirement、role-aware composite Storage Safety、Eligibility/Operation/dangerous-step current-usability fencing、real two-Host same-history Terminal PASS) |
| AVR-023 | availability-responsibility-architecture, execution-architecture, failure-model | ADR-0007, ADR-0010, ADR-0015 | INV-AVR-040 | AT-AVR-025, FI-AVR-019 | Implemented (exact PostgreSQL Lease-bound real helper、capability-free full identity binding、ordinary Result/Verification/Receipt/Job convergence、same Failure Epochからg01→g02 Terminal Decisionまでphysical PASS) |
| AVR-024 | availability-responsibility-architecture, execution-architecture, failure-model, storage-attachment-fencing-architecture, placement-architecture | ADR-0006, ADR-0007, ADR-0010, ADR-0015, ADR-0017, ADR-0019 | INV-AVR-041 | AT-AVR-026, FI-AVR-020 | Implemented for isolated `RESTART_ON_OTHER_HOST` Local LVM/zero-Port/no-PCI profile (migration 058: FENCED Host closed read-only Verification Lease、one real g01→g02 PostgreSQL history、atomic VERIFIED/RECOVERED/RELEASED、complete cleanup) |
| AVR-025〜AVR-033 | availability-responsibility-architecture, placement-architecture, execution-architecture, backend-cleanup-authority, failure-model | ADR-0006, ADR-0007, ADR-0010, ADR-0015, ADR-0017 | INV-AVR-042〜INV-AVR-050 | AT-AVR-027〜AT-AVR-035, FI-AVR-021〜FI-AVR-026 | Partial (migration 066: planned parent/workload-set/child/drain/slot/quiescence/terminal authority、Placement drain fencing、3 child/max=2 slot/failure escalation synthetic PostgreSQL qualification。Local LVM/real PCI/materialization cleanup producer/real two-Host campaignはBLOCKEDまたは継続) |
...
| NET-016, NET-017, NET-018, NET-055, NET-056 | network-resource-architecture, placement-architecture, availability-responsibility-architecture, execution-architecture | ADR-0006, ADR-0007, ADR-0015, ADR-0020 | INV-NET-007, INV-NET-008, INV-NET-040, INV-NET-041, INV-NET-042 | AT-NET-009, AT-NET-010, AT-NET-046, AT-NET-047, AT-NET-048, FI-NET-007, FI-NET-008, FI-NET-032, FI-NET-033, FI-NET-034 | Partial (single current Port Binding、generic typed OVN UNBIND、exact-incarnation retirement history/latest projection、immutable NB/SB/source-OVS retirement evidence、repeated source-quiescence/PortBindingHandoff、exact Port/MAC/IP preservation、Recovery Final Admission/Verification generation fencingを実装。PostgreSQL 17で同一Port `1/1→2/2→3/3` authority chainとg01→g02 Local LVM/non-empty OVS Port real Recoveryをqualification済み。real repeated two-Host Recovery、PCI/SR-IOV、generic cleanup authorityは継続) |
...
| NET-057, NET-058, NET-059, NET-060, NET-061 | network-resource-architecture, network-dataplane-target-architecture, placement-architecture | ADR-0020, ADR-0031 | INV-NET-043, INV-NET-044, INV-NET-045, INV-NET-046, INV-NET-047 | AT-NET-049, AT-NET-050, AT-NET-051, AT-NET-052, AT-NET-053, FI-NET-035, FI-NET-036 | Implemented (Migration 077; PostgreSQL 17 synthetic authority and typed adapter fixture; public API/provider and real OVN campaign pending) |
| NET-062, NET-063, NET-064, NET-065, NET-066, NET-067, NET-068, NET-069 | network-resource-architecture, placement-architecture | ADR-0020, ADR-0031, ADR-0032 | INV-NET-048, INV-NET-049, INV-NET-050, INV-NET-051, INV-NET-052, INV-NET-053, INV-NET-054 | AT-NET-054, AT-NET-055, AT-NET-056, AT-NET-057, AT-NET-058, FI-NET-037, FI-NET-038, FI-NET-039, FI-NET-040 | Implemented (Migration 078; PostgreSQL 17 synthetic authority/Final Admission/typed adapter; public API/provider, IPv6/router and real OVN pending) |
| NET-070, NET-071, NET-072, NET-073, NET-074, NET-075, NET-076, NET-077 | network-resource-architecture, placement-architecture | ADR-0020, ADR-0033 | INV-NET-055, INV-NET-056, INV-NET-057, INV-NET-058, INV-NET-059 | AT-NET-059, AT-NET-060, AT-NET-061, AT-NET-062, AT-NET-063, FI-NET-041, FI-NET-042, FI-NET-043 | Implemented (Migration 079; PostgreSQL 17 desired/MAC/IPAM/attachment/Final Admission/typed LSP/read-back/retirement; public API/provider and real OVN pending) |
...
| DPL-021, DPL-022, DPL-023, DPL-024 | nfv-dataplane-resource-architecture, workload-resilience-intent-architecture, data-persistence-architecture | ADR-0006, ADR-0010, ADR-0012, ADR-0018 | INV-DPL-015, INV-DPL-016, INV-DPL-017, INV-DPL-018 | AT-DPL-018, AT-DPL-019, AT-DPL-020, FI-PCI-005, FI-PCI-006, FI-PCI-007, FI-PCI-008 | Generic authority implemented; real two-Host campaign BLOCKED because g01/g02 expose no SR-IOV VF (`physfn` set empty) |

## 14. Operations / Observability / Audit

| Requirements | Architecture | ADR | Invariants | Tests | 状態 |
|---|---|---|---|---|---|
| OPS-001, OPS-002 | api-principles, execution-architecture | ADR-0002, ADR-0029 | INV-API-001, INV-API-010 | AT-API-001, AT-OPS-001 | Partial (Project is synchronous PostgreSQL-only; unified backend Operation projection remains planned) |
| IAC-001, IAC-002, IAC-005, IAC-006, IAC-010, IAC-011 | infrastructure-lifecycle-iac-architecture, api-principles, domain-model | ADR-0002, ADR-0006, ADR-0018, ADR-0029 | INV-API-004, INV-API-005, INV-API-006, INV-API-008 | AT-IAC-001, AT-IAC-002, AT-IAC-003, AT-IAC-005, AT-IAC-009 | Partial (Project runtime/OpenAPI/lifecycle metadata implemented; remaining resource contracts planned) |
| IAC-003, IAC-004, IAC-009, IAC-012 | infrastructure-lifecycle-iac-architecture, api-principles, data-persistence-architecture | ADR-0002, ADR-0010, ADR-0018, ADR-0029 | INV-API-002, INV-API-003, INV-API-009 | AT-API-002, AT-API-003, AT-IAC-006, AT-IAC-007, AT-IAC-008 | Partial (Project idempotency/revision/delete/error contract implemented) |
| IAC-007, IAC-008 | infrastructure-lifecycle-iac-architecture, execution-architecture | ADR-0002, ADR-0007, ADR-0010 | INV-API-007, INV-EXEC-001 | AT-IAC-004, AT-OPS-001, AT-OPS-005 | Planned (subsystem operations exist; unified Northbound Operation projection absent) |
| IAC-013 | infrastructure-lifecycle-iac-architecture, security, responsibility-boundaries | ADR-0005, ADR-0023 | INV-AUTH-001, INV-AUTH-002, INV-SEC-001 | AT-IAC-010, AT-AUTH-001, AT-AUTH-003 | Partial (Project HUMAN/AUTOMATION + system/Project RBAC/audit implemented; broader tenant/site/rotation model planned) |
| IAC-014 | infrastructure-lifecycle-iac-architecture, network-resource-architecture, security | ADR-0011, ADR-0020 | INV-NET-011, INV-NET-013 | AT-IAC-011, AT-NET-017 | Planned (logical model/compiler not implemented) |
| IAC-015 | api-principles, infrastructure-lifecycle-iac-architecture | ADR-0002, ADR-0029 | INV-API-001, INV-API-010 | AT-API-001, AT-IAC-012 | Implemented and qualified for Project |
| IAC-016 | api-principles, infrastructure-lifecycle-iac-architecture | ADR-0018, ADR-0029 | INV-API-008, INV-API-011, INV-API-012 | AT-IAC-013, AT-IAC-014 | Implemented for Project+Flavor+closed SYSTEM Availability; Image correctly blocked |
| IAC-017 | api-principles, infrastructure-lifecycle-iac-architecture, availability-responsibility-architecture | ADR-0029 | INV-API-013, INV-API-014 | AT-IAC-015 | Implemented (Migration 075, closed SYSTEM non-automatic profiles) |
| IAC-018 | image-resource-architecture, api-principles | ADR-0029, ADR-0030 | INV-API-015 | AT-IAC-016 | Implemented and qualified (Migration 076 typed ingestion/read-back; content revision re-enters PENDING) |
| IAC-019 | infrastructure-lifecycle-iac-architecture, api-principles, terraform-provider-kim | ADR-0029, ADR-0030 | INV-API-004, INV-API-008, INV-API-009, INV-API-016 | AT-IAC-005, AT-IAC-006, AT-IAC-007, AT-IAC-009, AT-IAC-017 | Implemented and experimentally qualified for Project/Flavor/closed Availability/Image only |
| IAC-020 | infrastructure-lifecycle-iac-architecture, api-principles, terraform-provider-kim | ADR-0029, ADR-0035, ADR-0036, ADR-0037 | INV-API-002, INV-API-003, INV-API-017 | AT-API-002, AT-API-003, AT-IAC-018 | Implemented and qualified for Phase 1, Phase 2 Network/Subnet/unattached Port/backend-neutral Volume, and the bounded Phase 3 logical VM aggregate; maximum create/delete, two-Port EVACUATE no-drift, and ROOT+DATA EVACUATE no-drift pass; ROOT+DATA Recovery and maximum-profile composite mobility remain separate |
...
| Requirements | Architecture | ADR | Invariants | Tests | 状態 |
|---|---|---|---|---|---|
| UPG-001, UPG-002, UPG-003 | upgrade-and-compatibility-architecture | ADR-0021 | INV-UPG-001, INV-UPG-002, INV-UPG-022, INV-UPG-023 | AT-UPG-002, AT-UPG-003, AT-UPG-004, AT-UPG-029, AT-UPG-030, FI-UPG-001, FI-UPG-019, FI-UPG-020 | Partial (immutable ReleaseManifest/component/explicit edge/distrust、CompatibilityDecision、current worker binding foundation implemented。OVN worker N/N-1、revocation、FeatureGate rollback、upgrade 中 PostgreSQL HA qualification PASS; product-wide component graph/provenance/SBOM pending) |
| UPG-004, UPG-005 | upgrade-and-compatibility-architecture, data-persistence-architecture | ADR-0018, ADR-0021 | INV-UPG-003, INV-UPG-024〜029 | AT-UPG-005, AT-UPG-006, AT-UPG-031〜036, FI-UPG-010, FI-UPG-021〜026 | Partial (Campaign / Coordinator / Target executor / closed Debian/systemd backend、実 Host recovery、conflict quarantine を実装。Wave budget / recovery Plan / rollback は継続) |
| UPG-006, UPG-007 | upgrade-and-compatibility-architecture, host-grouping-architecture | ADR-0014, ADR-0021 | INV-UPG-007, INV-UPG-024, INV-UPG-026 | AT-UPG-007, AT-UPG-031, AT-UPG-033, FI-UPG-005, FI-UPG-015, FI-UPG-021, FI-UPG-023 | Partial (ordered canary/batch Wave、immutable Target snapshot、Target executor recovery、canary CONTINUE / PAUSE を実装。availability budget integration は継続) |
| UPG-008, UPG-009 | upgrade-and-compatibility-architecture | ADR-0021 | INV-UPG-004, INV-UPG-005, INV-UPG-022, INV-UPG-023 | AT-UPG-008, AT-UPG-029, AT-UPG-030, FI-UPG-002, FI-UPG-003, FI-UPG-019, FI-UPG-020 | Partial (OVN worker explicit N/N-1 edge、drain-aware claim fencing、edge/Manifest distrust、all-participant work-schema activation/rollback implemented; other Control Plane/Agent/Event writers pending) |
...
| UPG-011 | upgrade-and-compatibility-architecture, ha-dr | ADR-0009, ADR-0021 | INV-HA-001, INV-UPG-007, INV-UPG-025 | AT-UPG-001, AT-UPG-032, FI-UPG-015, FI-UPG-022 | Partial (実 Coordinator SIGKILL と synchronous PostgreSQL promotion で Campaign RPO 0 recovery を qualification。full Control Plane wave availability budget は継続) |
...
| UPG-022 | upgrade-and-compatibility-architecture, execution-architecture | ADR-0007, ADR-0021 | INV-UPG-003, INV-UPG-024〜029 | AT-UPG-022, AT-UPG-031〜036, FI-UPG-010, FI-UPG-021〜026 | Partial (Coordinator / Target の DB-backed recovery、package lock contention、interrupted package quarantine を実装。abort / recovery / rollback path は継続) |
