...
| UPG-004, UPG-005 | upgrade-and-compatibility-architecture, data-persistence-architecture | ADR-0018, ADR-0021 | INV-UPG-003, INV-UPG-024, INV-UPG-025, INV-UPG-026 | AT-UPG-005, AT-UPG-006, AT-UPG-031, AT-UPG-032, AT-UPG-033, FI-UPG-010, FI-UPG-021, FI-UPG-022, FI-UPG-023 | Partial (Campaign / immutable Plan / 実 Coordinator / 実 Target executor と process recovery を実装。実 package/service backend は継続) |
...
| UPG-022 | upgrade-and-compatibility-architecture, execution-architecture | ADR-0007, ADR-0021 | INV-UPG-003, INV-UPG-024, INV-UPG-025, INV-UPG-026 | AT-UPG-022, AT-UPG-031, AT-UPG-032, AT-UPG-033, FI-UPG-010, FI-UPG-021, FI-UPG-022, FI-UPG-023 | Partial (Coordinator と Target の DB-backed claim/renewal/Attempt、multiple UNKNOWN、実 successor read-back recovery を実装。abort / rollback path は継続) |
