...
| UPG-004, UPG-005 | upgrade-and-compatibility-architecture, data-persistence-architecture | ADR-0018, ADR-0021 | INV-UPG-003, INV-UPG-024 | AT-UPG-005, AT-UPG-006, AT-UPG-031, FI-UPG-010, FI-UPG-021 | Partial (Campaign / immutable Plan / coordinator claim / event authority と restart recovery を実装。full multi-process coordinator は継続) |
...
| UPG-022 | upgrade-and-compatibility-architecture, execution-architecture | ADR-0007, ADR-0021 | INV-UPG-003, INV-UPG-024 | AT-UPG-022, AT-UPG-031, FI-UPG-010, FI-UPG-021 | Partial (DB-backed coordinator claim generation、expiry UNKNOWN evidence、successor `RECOVER_FROM_DB` を実装。multi-replica coordinator runtime は継続) |
