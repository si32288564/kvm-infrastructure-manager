...
| IAC-020 | infrastructure-lifecycle-iac-architecture, api-principles, terraform-provider-kim | ADR-0029, ADR-0035 | INV-API-002, INV-API-003, INV-API-017 | AT-API-002, AT-API-003, AT-IAC-018 | Implemented and qualified for Phase 1 plus Phase 2 Network/Subnet/unattached Port/backend-neutral Volume; Phase 3 VM aggregate is proposed in `vm-aggregate-resource-architecture` / ADR-0036 and remains unimplemented |
