...
| NET-036, NET-037, NET-038 | network-resource-architecture, agent-protocol, execution-architecture | ADR-0001, ADR-0007, ADR-0020 | INV-NET-021, INV-NET-022, INV-NET-023, INV-CMP-004 | AT-NET-026, AT-NET-027, AT-CMP-012, FI-NET-019 | Partial (OVS/SRIOV_DIRECT pre-boot realization and READY authority implemented; real VF hardware certification and post-boot dataplane pending) |
