...
| HGR-008, HGR-009 | host-grouping-architecture, placement-architecture | ADR-0006, ADR-0014 | INV-HGR-006, INV-HGR-007, INV-HGR-018 | AT-HGR-006, AT-HGR-007, AT-HGR-019, FI-HGR-004, FI-HGR-012 | Partial (HostGroup membership/set/cardinality/hierarchy generation dry/final fencing implemented; weight and Placement Scope consumers pending) |
