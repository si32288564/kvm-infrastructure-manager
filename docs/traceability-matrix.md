...
| HGR-004, HGR-005, HGR-021 | host-grouping-architecture, extensibility-architecture | ADR-0011, ADR-0014 | INV-HGR-001, INV-HGR-004, INV-HGR-019 | AT-HGR-004, AT-HGR-005, AT-HGR-020, FI-HGR-013, XCT-HGR-001, XCT-HGR-002, XCT-HGR-003, XCT-HGR-004 | Partial (closed typed Selector revision/current、pure evaluation evidence、atomic Membership Set materialization、generation/drift/concurrency fencing implemented; external assertion verifier pending) |
