...
| CMP-001, CMP-002, CMP-003, CMP-011 | architecture, execution-architecture, placement-architecture, storage-attachment-fencing-architecture | ADR-0002, ADR-0006, ADR-0007, ADR-0019 | INV-API-001, INV-API-002, INV-API-003, INV-DATA-002, INV-EXEC-006, INV-CMP-001 | AT-CMP-001, AT-CMP-009, AT-API-002 | Partial (accepted Admission→immutable plan→typed Domain define/read-back foundation implemented; Image/Network realization、start/delete、public API pending) |
