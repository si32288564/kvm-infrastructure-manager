...
| CMP-001, CMP-002, CMP-003, CMP-011, CMP-012, CMP-013 | architecture, execution-architecture, placement-architecture, storage-attachment-fencing-architecture | ADR-0002, ADR-0006, ADR-0007, ADR-0019 | INV-API-001, INV-API-002, INV-API-003, INV-DATA-002, INV-EXEC-006, INV-CMP-001, INV-CMP-002, INV-CMP-003 | AT-CMP-001, AT-CMP-009, AT-CMP-010, AT-CMP-011, AT-API-002 | Partial (Admission→immutable plan→typed Domain/Image read-back→component readiness implemented; Network realization、power-on/delete、public API pending) |
