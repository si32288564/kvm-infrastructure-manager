...
| UPG-004, UPG-005 | upgrade-and-compatibility-architecture, data-persistence-architecture | ADR-0018, ADR-0021 | INV-UPG-003, INV-UPG-024, INV-UPG-025, INV-UPG-026, INV-UPG-027 | AT-UPG-005, AT-UPG-006, AT-UPG-031〜034, FI-UPG-010, FI-UPG-021〜024 | Partial (Campaign / Coordinator / Target executor / closed Debian/systemd backend と実 Host recovery を実装。Wave budget / rollback は継続) |
...
| UPG-022 | upgrade-and-compatibility-architecture, execution-architecture | ADR-0007, ADR-0021 | INV-UPG-003, INV-UPG-024〜027 | AT-UPG-022, AT-UPG-031〜034, FI-UPG-010, FI-UPG-021〜024 | Partial (Coordinator / Target の DB-backed recovery と実 package/service side effect 後の successor read-back を実装。abort / rollback path は継続) |
