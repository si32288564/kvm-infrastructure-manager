...
| UPG-004, UPG-005 | upgrade-and-compatibility-architecture, data-persistence-architecture | ADR-0018, ADR-0021 | INV-UPG-003, INV-UPG-024, INV-UPG-025 | AT-UPG-005, AT-UPG-006, AT-UPG-031, AT-UPG-032, FI-UPG-010, FI-UPG-021, FI-UPG-022 | Partial (Campaign / immutable Plan / 実 Coordinator process / claim renewal / HA restart recovery を実装。component executor orchestration は継続) |
| UPG-006, UPG-007 | upgrade-and-compatibility-architecture, host-grouping-architecture | ADR-0014, ADR-0021 | INV-UPG-007, INV-UPG-024 | AT-UPG-007, AT-UPG-031, FI-UPG-005, FI-UPG-015, FI-UPG-021 | Partial (ordered canary/batch Wave、immutable Target snapshot、maximum unavailable / failure threshold persistence、canary CONTINUE / PAUSE を実装。Wave executor / availability budget integration は継続) |
...
| UPG-022 | upgrade-and-compatibility-architecture, execution-architecture | ADR-0007, ADR-0021 | INV-UPG-003, INV-UPG-024, INV-UPG-025 | AT-UPG-022, AT-UPG-031, AT-UPG-032, FI-UPG-010, FI-UPG-021, FI-UPG-022 | Partial (DB-backed claim/renewal generation、expiry UNKNOWN、実 Coordinator successor `RECOVER_FROM_DB` を実装。abort / rollback coordinator path は継続) |
