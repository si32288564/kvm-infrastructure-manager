...
| Requirements | Architecture | ADR | Invariants | Tests | 状態 |
|---|---|---|---|---|---|
| NET-001, NET-008, NET-019, NET-020, NET-040, NET-041, NET-042, NET-045, NET-046, NET-047, NET-048, NET-049, NET-050, NET-051 | network-resource-architecture, architecture, execution-architecture | ADR-0007, ADR-0011, ADR-0020 | INV-NET-006, INV-NET-009, INV-NET-025, INV-NET-026, INV-NET-027, INV-NET-030, INV-NET-031, INV-NET-032, INV-NET-033, INV-NET-034, INV-NET-035, INV-NET-036 | AT-NET-002, AT-NET-007, AT-NET-011, AT-NET-029, AT-NET-030, AT-NET-031, AT-NET-034, AT-NET-035, AT-NET-036, AT-NET-037, AT-NET-038, AT-NET-039, AT-NET-040, AT-NET-041, AT-NET-042, FI-NET-006, FI-NET-007, FI-NET-021, FI-NET-022, FI-NET-023, FI-NET-025, FI-NET-026, FI-NET-027, FI-NET-028, FI-DB-003, FI-DB-004, FI-DB-005, FI-DB-006, XCT-NET-001, XCT-NET-002, XCT-NET-003, XCT-NET-004 | Partial (v2 Network/Port ownership separation、closed production-shape adapter、durable PostgreSQL multi-worker claim/renewal、実 process kill・synchronous PostgreSQL repeated failover・renewal response-loss・512-work multi-worker soak からの bounded read-back-first recovery、immutable OVN Port/NB/SB/chassis/logical-flow/Chassis/Encap/directed Geneve evidence implemented and real test KVM runtime qualified; sustained saturation、Network/Router/DHCP/Security multi-object realization pending) |
