...
| NET-016, NET-017, NET-018 | network-resource-architecture, placement-architecture, availability-responsibility-architecture | ADR-0006, ADR-0015, ADR-0020 | INV-NET-007, INV-NET-008, INV-NET-040 | AT-NET-009, AT-NET-010, AT-NET-046, FI-NET-007, FI-NET-008, FI-NET-032 | Partial (single current Port Binding、immutable source-quiescence/PortBindingHandoff evidence、exact Port/MAC/IP preservation、Recovery Final Admission/Verification generation fencingを実装。production-shape typed source OVN unbind/retirement work authorityとreal non-empty Network Recovery qualificationは継続) |
