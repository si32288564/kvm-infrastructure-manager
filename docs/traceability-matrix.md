...
| AVR-021 | availability-responsibility-architecture, failure-model, recovery-storm-control-architecture, placement-architecture, execution-architecture, storage-attachment-fencing-architecture, network-resource-architecture | ADR-0006, ADR-0007, ADR-0010, ADR-0015, ADR-0017, ADR-0019, ADR-0020 | INV-AVR-034, INV-AVR-035, INV-AVR-036 | AT-AVR-023, FI-AVR-017 | Implemented for closed `RESTART_ON_OTHER_HOST` no-PCI/zero-Port qualification (migration 055: exact destination materialization、pre-power safety gate、typed power UNKNOWN/read-back、pure multi-domain Verification、atomic Terminal Decision/Operation VERIFIED/Epoch RECOVERED/Budget RELEASED、stale generation/replay fencing)。実two-Host KVM、PCI/SR-IOV、non-empty Network、EVACUATE backendは継続 |
