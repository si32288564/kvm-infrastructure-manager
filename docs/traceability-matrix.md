...
| AVR-021 | availability-responsibility-architecture, failure-model, recovery-storm-control-architecture, placement-architecture, execution-architecture, storage-attachment-fencing-architecture, network-resource-architecture | ADR-0006, ADR-0007, ADR-0010, ADR-0015, ADR-0017, ADR-0019, ADR-0020 | INV-AVR-034, INV-AVR-035, INV-AVR-036 | AT-AVR-023, FI-AVR-017 | Implemented for closed `RESTART_ON_OTHER_HOST` no-PCI/zero-Port authority regression (migration 055/056: exact destination materialization、typed power UNKNOWN/read-back、post-power root holder、pure Verification、atomic Terminal Decision)。Migration 057 follow-upでisolated g01→g02 physical exact source `vda` holder-closedとdestination RUNNING/holder-openはPASS。real helper Resultをsame PostgreSQL Lease/Failure Epoch historyへingestしたTerminal E2Eは未実施のためoverallはBLOCKED。PCI/SR-IOV、non-empty Network、EVACUATE、generic cleanupは継続 |
| AVR-022 | availability-responsibility-architecture, failure-model, storage-attachment-fencing-architecture, execution-architecture | ADR-0007, ADR-0010, ADR-0015, ADR-0019 | INV-AVR-037, INV-AVR-038, INV-AVR-039 | AT-AVR-024, FI-AVR-018 | Implemented foundation (migration 057: exact source-root Evaluation/Proof、observation-only typed `vda` read-back、logical source retirement、role-aware composite Storage Safety、Eligibility/Operation/dangerous-step current-usability fencing)。real two-Host same-history Terminal resultはvalidation artifactに従う |
| AVR-023 | availability-responsibility-architecture, execution-architecture, failure-model | ADR-0007, ADR-0010, ADR-0015 | INV-AVR-040 | AT-AVR-025, FI-AVR-019 | Partial (exact PostgreSQL Lease-bound real g01 helper、capability-free full identity binding、ordinary Result/Verification/Receipt/Job convergenceはphysical PASS。same Failure Epochかg01→g02 Terminal Decisionまでの一本historyは未qualificationのためoverall BLOCKED) |
