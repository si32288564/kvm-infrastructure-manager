...
| GAP-V1-005 | Reusable | fsync/atomic rename generation、durable spool、at-least-once、digest ACK、retry/backpressure/quarantine | Phase 1 | Agent Gateway、Inbox/Outbox | spool/envelope/idempotency primitive を multiplexed Session Manager/Inbox Receipt へ適合 | OPS-003/006/009/010、AGT-002/007/009、INV-DATA-006、INV-AGT-013/015 |
...
| GAP-V1-007 | Conflicting | Agent が Controller Inventory/Command endpoint へ直接 mTLS。独立 Agent Gateway/session generation/multiplexing boundary なし | Phase 1 | Gateway Session Registry、Agent Session Manager、PKI/Profile | client semantics を再利用し、一つのmultiplexed Gateway sessionへ統合。direct endpointは期限付きbridge後に廃止 | NFR-SEC-001〜005、AGT-001〜011、INV-AGT-002/011〜017、AT-AGT-002/011〜014 |
