...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: verified `.deb`、real dpkg lock contention、Result loss を single install へ収束。実 `postinst` interruption は `half-configured` evidence から Target/execution を `FENCED`、Campaign を `PAUSED` とし再 claim を禁止。明示 recovery Plan、実 KIM component、Wave budget、campaign abort / rollback は継続 | AT-UPG-002〜007、AT-UPG-029〜036、FI-UPG-019〜026 |
| P1-D04 | Debian/Ubuntu package、systemd hardening、containerized Control Plane、offline install | A01/A05 | In Progress: isolated Debian/systemd Target backend、package database contention、incomplete package quarantine の実 Host qualification が PASS。v1 package pipeline の KIM artifact、offline bundle、product unit への移植は継続 | AT-UPG-034〜036、AT-OFFLINE-001、AT-DEPLOY-001/002 |
