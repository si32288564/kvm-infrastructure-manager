...
| P1-B06 | In Progress | HostGroup revision、whole-set membership、cardinality、hierarchy、Selector、Placement fencing、Upgrade/Maintenance Snapshot consumers、closed MAINTENANCE Group Policy Binding/resolutionを実装。[Group Policy Binding validation](validation/p1-b06-group-policy-binding-20260811.md) を追加。population-complete EXACTLY_ONE、external assertion verifier、Availability/Placement policy consumers、Placement Scope、failure-domain maintenance schedulingは継続 |
