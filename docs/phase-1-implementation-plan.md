...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: immutable release / Campaign authority に加え、実 `kim-upgrade-coordinator`、DB-time claim renewal、HOLD dedupe を実装。実 process SIGKILL + synchronous PostgreSQL failover 後に generation 2 `RECOVER_FROM_DB`、stale Result fence、`CONTINUE / batch-1` が PASS。multi-process component executor、Wave budget、canary Decision response-loss、campaign abort / rollback orchestration は継続 | AT-UPG-002〜007、AT-UPG-029〜032、FI-UPG-019〜022 |
