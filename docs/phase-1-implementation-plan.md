...
| P1-C03 | In Progress | VLAN Segment、explicit IP/MAC、Port identity、basic OVS/SR-IOV Port Binding を Final Admission に統合。OVS/SRIOV_DIRECT pre-boot、OVS Host-side post-boot、immutable OVN Port intent、NB/SB/chassis、logical-flow coverage、Chassis/Encap projection を実装。automatic IPAM、release quarantine、production OVN runtime、cross-chassis tunnel と multi-object realization は継続 |
...
| P1-C03 | VLAN/IPAM/MAC/Port Claim と basic Port Binding | A07/C02 | current Network/Subnet/Segment/Host mapping、explicit IP/MAC Claim、Port/Binding reservation、OVN Port intent/NB/SB/chassis/logical-flow/Encap projection を実装。automatic allocation、quarantine/release、production OVN runtime、cross-chassis tunnel と multi-object realization を継続 | AT-NET-002〜007、AT-NET-029、AT-NET-030 |
