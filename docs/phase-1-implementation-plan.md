...
| P1-B03 | write-before-execute journal と typed read-back verification | A05/A06/B02 | Agent journal、closed typed backend registry、mutation 後 crash の UNKNOWN/read-back reconciliation を実装し、KIM-owned state marker で検証。[typed round-trip validation](validation/p1-b03-typed-mutation-roundtrip-20260809.md) と [crash/resync validation](validation/p1-b04-runtime-crash-resync-20260809.md) を保持。libvirt backend と disk failure hardening を継続 | AT-EXEC-012、FI-AGENT-001/002/005、FI-TRANSPORT-001〜004 |
