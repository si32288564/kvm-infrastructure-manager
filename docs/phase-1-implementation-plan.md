...
| P1-B06 | In Progress | HostGroup revision、whole-set membership、cardinality、hierarchy、Selector、Placement fencing、Upgrade Snapshot consumerを実装。[Upgrade Snapshot consumer validation](validation/p1-b06-upgrade-snapshot-consumer-20260811.md) を追加。population-complete EXACTLY_ONE、external assertion verifier、policy binding、Placement Scope、Maintenance consumer bindingは継続 |
