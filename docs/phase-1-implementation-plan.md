...
| P1-C03 | VLAN/IPAM/MAC/Port Claim と basic Port Binding | A07/C02 | current Network/Subnet/Segment/Host mapping、explicit/automatic IP/MAC、release quarantine/reuse、v2 Network/LSP ownership分離、closed OVN runtime、NB/SB/chassis/logical-flow/Encap/Geneve evidenceを実装。実 test KVMのproduction-shape OVN/OVSで同一 Network 2 Port reconcile、NB/SB/chassis convergence、cleanupがPASS。durable multi-worker scheduling、external IPAM、policy-timed quarantine、Router/DHCP/Security multi-object realizationを継続 | AT-NET-002〜007、AT-NET-029〜035、FI-NET-024〜025 |
