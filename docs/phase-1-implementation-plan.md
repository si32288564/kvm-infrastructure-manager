...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: immutable Manifest/component/explicit N/N-1 edge、Compatibility Decision、current OVN worker binding、drain-aware claim fencing、work-schema FeatureGate を実装し実 N-1/N process qualification PASS。Campaign/Plan/Wave/Target と product-wide canary は継続 | AT-UPG-002〜007、AT-UPG-029、FI-UPG-019 |
