...
| P1-B06 | explicit HostGroup/Placement Pool membership generation | A02/B05 | first-class revision/current authority、whole-set generation、atomic current switch、set-backed snapshot、SYSTEM scope cardinality evidence/current、complete TREE hierarchy evidence/current、scope serialization、legacy backfill、Placement set/member/policy/hierarchy fencingを実装。population authority/selector/policy binding/Placement Scope/consumer bindingを継続 | AT-HGR-001/002/003/004/007/010/016/017/018/019、FI-HGR-002/003/004/005/009/010/011/012 |
