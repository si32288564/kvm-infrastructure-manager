...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: 実 Coordinator / Target executor に加え、closed Debian/systemd backend を実装。実 Ubuntu KVM 上で verified `.deb` v1→v2、systemd restart、executor SIGKILL、Attempt 2 `READ_BACK_FIRST`、package/process/health read-back、single install、次 Wave への収束が PASS。実 KIM component package、Wave budget、canary Decision response-loss、campaign abort / rollback は継続 | AT-UPG-002〜007、AT-UPG-029〜034、FI-UPG-019〜024 |
| P1-D04 | Debian/Ubuntu package、systemd hardening、containerized Control Plane、offline install | A01/A05 | In Progress: isolated Debian/systemd Target backend と hardened fixture unit の実 Host qualification が PASS。v1 package pipeline の KIM artifact、offline bundle、product unit への移植は継続 | AT-UPG-034、AT-OFFLINE-001、AT-DEPLOY-001/002 |
