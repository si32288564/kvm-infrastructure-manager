...
| P1-C03 | In Progress | VLAN Segment、explicit IP/MAC、Port identity、basic OVS/SR-IOV Port Binding を Final Admission に統合。OVS/SRIOV_DIRECT pre-boot と OVS Host-side post-boot realization を実装。automatic IPAM、release quarantine workflow、OVN realization は継続 |
