...
| P1-B06 | explicit HostGroup/Placement Pool membership generation | A02/B05 | first-class revision/current authority、whole-set generation、atomic current switch、set-backed snapshot、SYSTEM scope cardinality evidence/current、sibling scope serialization、legacy backfill、Placement set/member/policy fencingを実装。population authority/hierarchy/selector/policy binding/Placement Scope/consumer bindingを継続 | AT-HGR-001/002/003/004/007/010/016/017/018、FI-HGR-002/004/005/009/010/011 |
