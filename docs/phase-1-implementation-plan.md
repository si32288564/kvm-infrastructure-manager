...
| P1-B06 | In Progress | first-class HostGroup revision/current authority、whole-set membership generation、atomic publish、set-backed immutable snapshot、legacy Placement Pool compatibility、Placement dry/final set fencingを実装。[P1-B06 HostGroup validation](validation/p1-b06-host-group-authority-20260811.md) と [Membership Set Generation validation](validation/p1-b06-membership-set-generation-20260811.md) を保持。cardinality、hierarchy、selector、policy binding、Placement Scope、Upgrade/Maintenance consumer bindingは継続 |
...
| P1-B06 | explicit HostGroup/Placement Pool membership generation | A02/B05 | first-class revision/current authority、whole-set generation、atomic current switch、set-backed snapshot、legacy backfill、Placement set/member fencingを実装。cardinality/hierarchy/selector/policy binding/Placement Scope/consumer bindingを継続 | AT-HGR-001/002/004/007/010/016/017、FI-HGR-004/005/009/010 |
