...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: 実 Coordinator / Target executor と closed Debian/systemd backend を実装。verified `.deb`、real dpkg lock contention、executor SIGKILL を重ね、Attempt 3 まで `UNKNOWN / READ_BACK_FIRST` を維持して single install、次 Wave へ収束。install interruption、実 KIM component、Wave budget、campaign abort / rollback は継続 | AT-UPG-002〜007、AT-UPG-029〜035、FI-UPG-019〜025 |
| P1-D04 | Debian/Ubuntu package、systemd hardening、containerized Control Plane、offline install | A01/A05 | In Progress: isolated Debian/systemd Target backend、hardened fixture unit、package database contention の実 Host qualification が PASS。v1 package pipeline の KIM artifact、offline bundle、product unit への移植は継続 | AT-UPG-034/035、AT-OFFLINE-001、AT-DEPLOY-001/002 |
