...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: immutable Manifest/component/explicit N/N-1 edge、distrust evidence、Compatibility Decision、current OVN worker binding、drain-aware claim fencing、work-schema activation/rollback evidence を実装。実 N-1/N process、hard drain と synchronous PostgreSQL failover、edge/Manifest revocation 後の stale binding fence、single apply recovery が PASS。Campaign/Plan/Wave/Target と product-wide canary は継続 | AT-UPG-002〜007、AT-UPG-029/030、FI-UPG-019/020 |
