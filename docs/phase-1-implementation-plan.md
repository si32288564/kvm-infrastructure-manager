...
| P1-B06 | In Progress | HostGroup revision、whole-set membership、cardinality、hierarchy、Selector、Placement fencing、Upgrade/Maintenance Snapshot consumers、Group Policy Binding、closed Placement Scope authorityを実装。[Placement Scope validation](validation/p1-b06-placement-scope-authority-20260811.md) を追加。population-complete EXACTLY_ONE、external assertion verifier、Availability policy consumers、failure-domain maintenance schedulingは継続 |
...
| P1-B06 | explicit HostGroup/Placement Pool membership generation | A02/B05 | first-class revision/current authority、whole-set generation、atomic current switch、set-backed snapshot、SYSTEM scope cardinality、TREE hierarchy、typed Selector、Placement fencing、Upgrade/Maintenance Snapshot consumers、cross-domain disruption fencingを実装。population authority/external assertion verifier/MAINTENANCE Group Policy Binding/resolution/Plan provenanceとclosed VM_PLACEMENT Scope authorityを実装。Availability policy consumers、failure-domain maintenance schedulingを継続 | AT-HGR-001/002/003/004/005/007/010/016/017/018/019/020/021/022/023/024、FI-HGR-002/003/004/005/009/010/011/012/013/014/015/016/017 |
