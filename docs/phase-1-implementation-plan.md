...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: 実 Coordinator に加え、実 `kim-upgrade-target-executor`、Target claim / renewal / Attempt / Observation / Result authority、closed typed state-marker backend を実装。3 Target の side effect 後 SIGKILL から Attempt 2 `READ_BACK_FIRST`、single apply、次 Wave への収束が PASS。実 component package/service backend、Wave budget、canary Decision response-loss、campaign abort / rollback orchestration は継続 | AT-UPG-002〜007、AT-UPG-029〜033、FI-UPG-019〜023 |
