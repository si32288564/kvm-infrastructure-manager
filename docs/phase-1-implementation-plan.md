...
| P1-C03 | In Progress | VLAN Segment、explicit IP/MAC、Port identity、basic OVS/SR-IOV Port Binding を Final Admission に統合。OVS/SRIOV_DIRECT pre-boot、OVS Host-side post-boot、immutable OVN Port intent、NB/SB/chassis、logical-flow coverage、Chassis/Encap projection、directed Geneve tunnel evidence authority を実装。automatic IPAM、release quarantine、production OVN runtime、実 2 Host tunnel qualification と multi-object realization は継続 |
...
| P1-C03 | VLAN/IPAM/MAC/Port Claim と basic Port Binding | A07/C02 | current Network/Subnet/Segment/Host mapping、explicit IP/MAC Claim、Port/Binding reservation、OVN Port intent/NB/SB/chassis/logical-flow/Encap projection、directed Geneve tunnel evidence authority を実装。単一 Host の隔離 2 endpoint kernel fixture は verifier contract に限定。automatic allocation、quarantine/release、production OVN runtime、実 2 Host tunnel qualification、multi-object realization を継続 | AT-NET-002〜007、AT-NET-029〜031 |
