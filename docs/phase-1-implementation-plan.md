...
| P1-B06 | In Progress | first-class HostGroup revision/current authority、typed group/dimension、many-to-many materialized membership、immutable snapshot、legacy Placement Pool compatibility、Placement dry/final generation fencingを実装。[P1-B06 HostGroup validation](validation/p1-b06-host-group-authority-20260811.md) を保持。cardinality、hierarchy、selector、policy binding、Placement Scope、snapshot consumer bindingは継続 |
...
| P1-B06 | explicit HostGroup/Placement Pool membership generation | A02/B05 | first-class revision/current authority、typed dimension/level、many-to-many materialized membership、immutable snapshot、legacy Placement Pool compatibility、Placement generation fencingを実装。cardinality/hierarchy/selector/policy binding/Placement Scopeを継続 | AT-HGR-001/002/004/007/010、FI-HGR-004/005 |
