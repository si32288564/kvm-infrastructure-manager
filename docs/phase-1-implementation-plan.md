...
| P1-C03 | In Progress | VLAN Segment、explicit IP/MAC、Port identity、basic OVS/SR-IOV Port Binding を Final Admission に統合。OVS/SRIOV_DIRECT pre-boot、OVS Host-side post-boot、immutable OVN Port intent、NB/SB/chassis、logical-flow coverage、Chassis/Encap projection、directed Geneve tunnel evidence authority を実装。実 2 物理 Host の kernel Geneve と隔離 OVN-generated Port-bound Geneve path は MTU 1400 双方向 probe まで PASS。automatic IPAM、release quarantine、production OVN runtime と multi-object realization は継続 |
...
| P1-C03 | VLAN/IPAM/MAC/Port Claim と basic Port Binding | A07/C02 | current Network/Subnet/Segment/Host mapping、explicit IP/MAC Claim、Port/Binding reservation、OVN Port intent/NB/SB/chassis/logical-flow/Encap projection、directed Geneve tunnel evidence authority を実装。単一 Host verifier、実 2 物理 Host kernel Geneve、隔離 OVN-generated Port-bound Geneve/MTU qualification は PASS。automatic allocation、quarantine/release、production OVN runtime、multi-object realization を継続 | AT-NET-002〜007、AT-NET-029〜031 |
