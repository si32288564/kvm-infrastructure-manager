...
| P1-C06 | Availability Policy/VM Binding と Workload Resilience/Recovery Queue read-only model | B06/C02 | Availability Policy/Binding/Rebind、Failure Epoch、typed Confirmation、independent Fencing/Local LVM Storage Safety Proof、typed GLOBAL/PLANNING Recovery Budget、Eligibility、explicit Recovery Operation Request/Plan、start-time safety gate、destination Final Admission、typed preparation dispatchを実装。[Recovery Operation validation](validation/p1-recovery-operation-authority-20260811.md) を保持。actual VM rematerialization、Recovery VERIFIED、terminal Budget releaseは継続 | AT-AVR-001〜022、AT-WRI-001 |
