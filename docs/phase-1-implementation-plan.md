...
| P1-B06 | In Progress | HostGroup revision、whole-set membership、cardinality、hierarchy、Selector、Placement fencing、Upgrade/Maintenance Snapshot consumersを実装。[Upgrade Snapshot validation](validation/p1-b06-upgrade-snapshot-consumer-20260811.md) と [Maintenance Snapshot validation](validation/p1-b06-maintenance-snapshot-consumer-20260811.md) を追加。population-complete EXACTLY_ONE、external assertion verifier、policy binding、Placement Scope、failure-domain maintenance schedulingは継続 |
