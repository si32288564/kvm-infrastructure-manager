...
| P1-D03 | Release Manifest、artifact digest、schema readiness、single-target canary | A01/A02 | In Progress: immutable Manifest/edge/distrust/Compatibility Decision と OVN worker rolling fault gate に加え、product-wide Campaign / Plan / acyclic component graph / provenance / SBOM / Wave / Target / canary threshold、DB-backed coordinator recoveryを実装。実 PostgreSQLで response-loss replay、stale coordinator fence、CONTINUE / PAUSE が PASS。multi-process component executor、Wave budget、campaign abort / rollback orchestration は継続 | AT-UPG-002〜007、AT-UPG-029〜031、FI-UPG-019〜021 |
