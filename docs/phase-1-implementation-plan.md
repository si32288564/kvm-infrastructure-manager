...
| P1-C06 | Availability Policy/VM Binding と Workload Resilience/Recovery Queue read-only model | B06/C02 | Availability Policy/Binding/Rebind、Failure Epoch、typed Confirmation、independent Fencing/Local LVM Storage Safety Proof、typed GLOBAL/PLANNING Recovery Budget、Eligibility、Recovery Operation/Plan、destination materialization/Terminal、source root/Network/PCI retirement・handoff、generic cleanup/producer adapter/READ_BACK_FIRST/delayed A cleanupを実装。Migration 066でFailure Recoveryと分離したplanned Host evacuation drain、immutable workload set、parent/child、bounded slot、planned quiescence、partial/source-failure/terminal authorityを追加し3 child/max=2 synthetic PostgreSQL campaignをPASS。Local LVM evacuation/data-independent cleanup、real PCI、materialization cleanup producer、real two-Host evacuationはBLOCKEDまたは継続。g01→g02 Recovery Local LVM/zero-Portおよびnon-empty OVS Port/no-PCI campaignはPASS | AT-AVR-001〜035、AT-CMP-014〜019、AT-WRI-001、AT-NET-046〜048、AT-DPL-018〜020 |
