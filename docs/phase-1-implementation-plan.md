...
| P1-B06 | In Progress | first-class HostGroup revision/current authority、whole-set membership generation、atomic publish、set-backed immutable snapshot、SYSTEM scope cardinality policy authority、complete TREE-profile hierarchy generation、closed typed Selector proposal/materialization、legacy Placement Pool compatibility、Placement dry/final set/policy/hierarchy/selector fencingを実装。[P1-B06 HostGroup validation](validation/p1-b06-host-group-authority-20260811.md)、[Membership Set Generation validation](validation/p1-b06-membership-set-generation-20260811.md)、[Cardinality validation](validation/p1-b06-cardinality-authority-20260811.md)、[Hierarchy validation](validation/p1-b06-hierarchy-authority-20260811.md)、[Selector validation](validation/p1-b06-selector-materialization-20260811.md) を保持。population-complete EXACTLY_ONE、external assertion verifier、policy binding、Placement Scope、Upgrade/Maintenance consumer bindingは継続 |
...
| P1-B06 | explicit HostGroup/Placement Pool membership generation | A02/B05 | first-class revision/current authority、whole-set generation、atomic current switch、set-backed snapshot、SYSTEM scope cardinality evidence/current、complete TREE hierarchy evidence/current、closed typed Selector revision/evaluation/materialization、scope serialization、legacy backfill、Placement set/member/policy/hierarchy/selector fencingを実装。population authority/external assertion verifier/policy binding/Placement Scope/consumer bindingを継続 | AT-HGR-001/002/003/004/005/007/010/016/017/018/019/020、FI-HGR-002/003/004/005/009/010/011/012/013 |
