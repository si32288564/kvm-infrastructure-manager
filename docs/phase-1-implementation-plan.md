...
| P1-C06 | Availability Policy/VM Binding と Workload Resilience/Recovery Queue read-only model | B06/C02 | Availability Policy/Binding/Rebind、Failure Epoch、typed Confirmation、independent Fencing/Local LVM Storage Safety Proof、typed GLOBAL/PLANNING Recovery Budget、Eligibility、explicit Recovery Operation/Plan、destination Final Admission、existing Local LVM/VM/Image/Attachment/Power materialization、UNKNOWN/read-back、pure Recovery Verification、atomic Terminal Decision/Operation VERIFIED/Epoch RECOVERED/Budget RELEASEDを実装。Migration 057〜062のsource root/Network retirement・handoffに加え、Migration 063でgeneric exact-incarnation VF retirement/handoff、closed `PCI_VF_RETIRE/v1`、destination SR-IOV realizationとRecovery dangerous-step/Verification consumerを追加。g01→g02 Local LVM/zero-Portおよびnon-empty OVS Port/no-PCI campaignはPASS。PCI/SR-IOV real campaignはread-only preflightで両HostにVFが存在しないため安全にBLOCKED。[PCI/SR-IOV validation](validation/p1-pci-sriov-recovery-authority-20260813.md)を保持。real repeated two-Host Recovery、disposable VF hardware qualification、EVACUATE backend、generic source/backend cleanup、soak/chaosは継続 | AT-AVR-001〜026、AT-WRI-001、AT-NET-046〜048、AT-DPL-018〜020 |
