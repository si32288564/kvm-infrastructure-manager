...
| P1-B06 | In Progress | HostGroup revision、whole-set membership、cardinality、hierarchy、Selector、External Assertion verifier/materialization、Placement fencing、Upgrade/Maintenance Snapshot consumers、Group Policy Binding、closed Placement Scope authorityを実装。Availability consumerはVM Binding、Explicit Rebind、Failure Epoch、typed Confirmation、independent typed Fencing/Local LVM Storage Safety Proofまで接続。[External Assertion validation](validation/p1-b06-external-assertion-verifier-20260811.md)、[Typed safety validation](validation/p1-typed-fencing-storage-safety-20260811.md) を追加。population-complete EXACTLY_ONE、Recovery Eligibility、failure-domain maintenance schedulingは継続 |
...
| P1-C06 | Availability Policy/VM Binding と Workload Resilience/Recovery Queue read-only model | B06/C02 | Availability Policy/Binding/Rebind、Failure Epoch、typed Confirmation、independent Fencing/Local LVM Storage Safety Proofを実装。Recovery Eligibility/Operationとautomatic recoveryは未実装 | AT-AVR-001〜020、AT-WRI-001 |
