...
> Public contract completion addendum (2026-08-15): Migration 088, `/api/v1/vms`, and Terraform `kim_vm` expose the qualified aggregate profile without physical incarnation fields. Migration 089 qualifies one STANDARD Port delete while preserving logical Port identity. Migration 090 qualifies ROOT+DATA delete while preserving both logical Volumes, capacity and materialization authority. The composite qualification binds both authorities in one one-Port+ROOT+DATA terminal without a new migration. Two-Port delete remains fail-closed. See [VM Northbound / Terraform qualification](../validation/p3-vm-northbound-terraform-resource-20260815.md), [one-Port delete qualification](../validation/p3-vm-standard-port-delete-20260815.md), [ROOT+DATA delete qualification](../validation/p3-vm-data-volume-delete-20260815.md), [combined delete qualification](../validation/p3-vm-standard-port-data-delete-20260815.md), and [ADR-0037](../adr/0037-vm-northbound-and-terraform-contract.md).
