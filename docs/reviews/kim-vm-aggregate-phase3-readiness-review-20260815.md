...
> Public contract completion addendum (2026-08-15): Migration 088, `/api/v1/vms`, and Terraform `kim_vm` expose the qualified aggregate profile without physical incarnation fields. Migrations 089/090 independently qualify logical Port and Volume preservation. Migration 091 adds canonical per-Port operation/absence evidence and complete absence-set terminal binding. The maximum-profile qualification composes the Migration 091 two-Port set with Migration 090 DATA absence in one terminal, so public delete now covers the same bounded profile matrix as create. See [VM Northbound / Terraform qualification](../validation/p3-vm-northbound-terraform-resource-20260815.md), [two-Port delete qualification](../validation/p3-vm-two-standard-port-delete-20260815.md), [maximum-profile delete qualification](../validation/p3-vm-maximum-profile-delete-20260815.md), and [ADR-0037](../adr/0037-vm-northbound-and-terraform-contract.md).
