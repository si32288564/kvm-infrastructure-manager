...
> Public contract completion addendum (2026-08-15): Migration 088, `/api/v1/vms`, and Terraform `kim_vm` expose the qualified aggregate profile without physical incarnation fields. Migration 089 qualifies one STANDARD Port delete while preserving logical Port identity. Migration 090 qualifies ROOT+DATA delete while preserving both logical Volumes, capacity and materialization authority. Their composite qualification binds one-Port+ROOT+DATA in one terminal. Migration 091 adds canonical per-Port operation/absence evidence and a complete absence-set terminal binding for two-Port+ROOT delete. Two-Port+DATA delete remains fail-closed. See [VM Northbound / Terraform qualification](../validation/p3-vm-northbound-terraform-resource-20260815.md), [combined delete qualification](../validation/p3-vm-standard-port-data-delete-20260815.md), [two-Port delete qualification](../validation/p3-vm-two-standard-port-delete-20260815.md), and [ADR-0037](../adr/0037-vm-northbound-and-terraform-contract.md).
