...
func TestMigratePostgreSQLIntegration(t *testing.T) {
	...
	requiredTables := []string{
		...
		"subnet_resource_revision_evidence",
		"subnet_ipam_pool_decision_evidence",
		"subnet_ipam_pools_current",
		"subnet_ipam_pool_lifecycle_evidence",
		"subnet_ip_allocation_decision_evidence",
		"subnet_ip_allocations_current",
		"subnet_ip_allocation_release_evidence",
		"subnet_realization_operation_evidence",
		"subnet_realization_attempt_evidence",
		"subnet_realization_attempt_event_evidence",
		"subnet_realization_observation_evidence",
		"subnet_realization_terminal_evidence",
		"subnet_realizations_current",
		"northbound_flavor_idempotency_evidence",
		"northbound_availability_policy_idempotency_evidence",
		"northbound_phase2_idempotency_evidence",
		"northbound_vm_idempotency_evidence",
		"vm_aggregate_port_binding_evidence",
		...
		"host_evacuation_source_storage_volume_safety_evidence",
		"host_evacuation_source_storage_safety_set_evidence",
		"vm_materialization_relocation_volume_evidence",
		"vm_logical_update_evidence",
		"vm_power_update_command_authority_evidence",
		"vm_power_update_verification_evidence",
		"vm_power_update_terminal_evidence",
		"vm_delete_operation_evidence",
		"vm_delete_domain_absence_evidence",
		"vm_delete_storage_absence_evidence",
		"vm_delete_compute_release_evidence",
		"vm_delete_terminal_evidence",
		"vm_resource_tombstone_evidence",
